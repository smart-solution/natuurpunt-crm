...
class res_partner_address_history(osv.osv):
    ...
    _columns = {
        ...
        'name': fields.char('Naam', len=128, select=True),
        'ref': fields.char('Code', len=32),
        'street': fields.char('Straat', len=64, select=True),
        'street2': fields.char('Straat(2)', len=64),
        'zip': fields.char('Postcode', len=64, select=True),
        'city': fields.char('Gemeente', len=64, select=True),
